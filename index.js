...
//internal can be accessed because the function calling it is at the same level of scope
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooArr){
    let displayNames = []
    zooArr.forEach(element => {displayNames.push(`name: ${element.animal_name}, scientific: ${element.scientific_name}`)
    });
    return displayNames
  }
  ...
  */
  ...
  function lowerCaseNames(zooArr){
    return zooArr.map(element => element.animal_name.toLowerCase())
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooArr){
    return zooArr.filter(element => element.population < 5)
  }
  ...
  */
  ...
  function USApop(zooArr){
    return zooArr.reduce( (accu,curr) => accu += curr.population,0)
  }
